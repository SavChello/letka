...
const double RAND_EPS = 0.5;
const double MY_RAND_MAX = 1e11;
const double MY_RAND_MIN = -1e11;
...
#define COUNT_RANDOM_TESTS 1000
#define TXT_UNITS_NUMS "UNIT_test.txt"
#define TXT_UNITS_STRS "UNIT_test_CHECK_NUM.txt"
...
struct ReadNumsUnits {
        ...
        enum rootCount real_count_roots;     ///< The number of roots
